...
The  "Attack Surface Management" course explores ways of identifying and  reducing system vulnerabilities to improve cybersecurity defenses. This  involves strategies and techniques to bolster security effectively.
...
- [Attack Surface Management](https://app.letsdefend.io/training/quiz/attack-surface-management)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/2/asm1.png)
...
1 - What is the name of the process of analyzing our assets and the security status of these assets?

> **Answer:** Risk Assessment

2 - What is the name of the process of making a list of our assets?

> **Answer:** Asset Discovery

3 - What is the name of the  process of identifying and shutting down assets such as unnecessary or  unused computers, servers, software, or services?

> **Answer:** Asset Reduction
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/3/asm_new1.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/3/asm2.png)

When we asked AMASS to enumerate the google.com domain, the output we got was as follows:  

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/3/asm3.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/3/asm4.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/3/asm10.png)
...
1 - Which open source tool promises to perform network mapping of attack  surfaces and external asset discovery using open source information  gathering and active discovery techniques?

> **Answer:** OWASP AMASS

2 - Which tool is used to scan modern applications, infrastructures, cloud environments and networks and is known for its speed?
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm5.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm6.png)

You can quickly start a scan task using the Task Wizard in the Scans menu:

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm7.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm8.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm11.png)

When you click on each vulnerability, you can access the details of that vulnerability and information on how to fix it:

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Attack+Surface+Management/4/asm9.png)
