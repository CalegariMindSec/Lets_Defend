...
The "Cyber Threat Intelligence for Detection" course is dedicated to equipping  participants with specialized skills in cyber threat intelligence to  optimize and empower detection strategies within the cybersecurity  landscape.
...
- [Cyber Threat Intelligence for Detection](https://app.letsdefend.io/training/quiz/cyber-threat-intelligence-for-detection)
...
1 - What does the letter "I" in the abbreviation CTI stand for?

> **Answer:** Intelligence

2 - What is the abbreviation of Open Source Intelligence?

> **Answer:** OSINT

3 - What is the abbreviation of Technical Intelligence?

> **Answer:** TECHINT

4 - What is the name of the platform that facilitates the sharing of cyber threat information between financial institutions?
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/2/cti2.png)
...
1 - What is the name given to  the anonymous part of the Internet that is accessed using private  browsers and networks (e.g. Tor, I2P)?

> **Answer:** Darkweb

2 - What does the letter O in the abbreviation TOR stand for?
...
echo "deb -src [arch= amd64 signed-by=/usr/share/keyrings/tor-archive-keyring.gpg] https://deb.torproject.org/torproject.org focal main
" >> /etc/apt/sources.list.d/tor.list           
```
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/cti5.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/cti6.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/cti7.png)

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/cti8.png)

### TorBot

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/n1.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/mon-table.png)

To run TorBot,

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/n2.png)

### Firefox Monitor

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/3/n3.png)
...
1 - What is the name of the browser customized to visit sites with .onion extension?
...
Individuals or groups who believe in political or social causes carry out cyber attacks to send messages to their targets.  
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/4/cti9.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/4/cti20.png)

![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Cyber+Threat+Intelligence+for+Detection/4/cti21.png)
...
1 - What is the name given to software that records the user's keyboard keystrokes and sends this information to malicious people?

> **Answer:** keylogger

2 - What is the short name for  technical data that helps determine whether a computer network or system is under the influence of malicious activity?

> **Answer:** IOC

3 - What is the name of the  non-profit platform used to identify and classify the tactics,  techniques and procedures ( TTP ) of cyber threats?
