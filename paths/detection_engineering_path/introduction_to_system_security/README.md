...
- [Introduction to System Security](https://app.letsdefend.io/training/quiz/system-security)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/2/image2-1.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/2/opsys1.png)
...
1 - What is a multi-user and multitasking operating system that was developed by Bell Labs?
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/3/image2-2.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/3/image2-3.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/image2.png)

1 - The image above shows the output of the "top" command on Linux.  According to this image, how many GB is the total main memory capacity?

> **Answer:** 2

2 - What is the process performed by the operating system to allocate memory block for other processes after a process ends?

> **Answer:** deallocation

3 - What is memory management with the "first-fit", "best-fit" and "worst-fit" strategies applied?

> **Answer:** Physical Memory Management
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/4/image2-4.png)
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/4/image2-5.png)
...
1 - What is the IP address of the DNS Server that was last added to the DNS  Server configuration (at the bottom of the configuration file) on the  Linux lab machine you are connected to?

> **Answer:** 127.0.0.53

2 - What is the system that helps the organization and storage of files called?

> **Answer:** Filesystem

3 - What is the process of managing files on physical storage media called?
...
1 - What is the version of the "nano" tool installed on the Linux lab machine you are connecting to?

> **Answer:** 4.8

2 - What is changing software from a previous version to a newer version?
...
![img](https://letsdefend-images.s3.us-east-2.amazonaws.com/Courses/Introduction-to-system-security/6/image6-1.jpeg)
...
*You can address all of the above topics with various SIEM solutions via:*
...
1 - What is the product that can collect and analyze logs from different systems and applications in one place? 
